...
## Roadmap
  ...
  default-value: 0
  disabled: true
  :items: '[{"title":"Navigation","description":"Navigation pour afficher plus de
    résultats dans les listes de films et séries en salles et populaires
    etc.","icon":"i-lucide-lock"},{"title":"Recherche","description":"Ajouter une
    fonction de recherche avec filtres et tri par types, dates, notes,
    etc.","icon":"i-lucide-lock"},{"title":"SEO","description":"Travail sur le SEO
    les balises
    meta","icon":"i-lucide-lock"},{"title":"Authentification","description":"Création
    de comptes utilisateur et
    authentification","icon":"i-lucide-lock"},{"title":"Social","description":Fonctionnalités
    sociales : poster des commentaires, faire des listes, noter des
    oeuvres,"icon":"i-lucide-lock"}]'
  orientation: vertical
  ---
  :::
::
